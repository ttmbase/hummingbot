...
from hummingbot.connector.exchange.ttmbase.ttmbase_order_book import TtmBASEOrderBook
from hummingbot.connector.exchange.ttmbase.ttmbase_order_book_message import TtmBASEOrderBookMessage
...
class TtmBASEOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self, trading_pairs: Optional[List[str]] = None,):
        super().__init__(TtmBASEAPIOrderBookDataSource(trading_pairs), trading_pairs)
        ...
        self._order_books: Dict[str, TtmBASEOrderBook] = {}
        self._saved_message_queues: Dict[str, Deque[TtmBASEOrderBookMessage]] = \
    ...
    async def _track_single_book(self, trading_pair: str):
        ...
        """
        past_diffs_window: Deque[TtmBASEOrderBookMessage] = deque()
        self._past_diffs_windows[trading_pair] = past_diffs_window

        message_queue: asyncio.Queue = self._tracking_message_queues[trading_pair]
        order_book: TtmBASEOrderBook = self._order_books[trading_pair]
        ...
        while True:
            try:
                message: TtmBASEOrderBookMessage = None
                saved_messages: Deque[TtmBASEOrderBookMessage] = self._saved_message_queues[trading_pair]
                ...
                if message.type is OrderBookMessageType.DIFF:
                    ...
                    past_diffs: List[TtmBASEOrderBookMessage] = list(past_diffs_window)
