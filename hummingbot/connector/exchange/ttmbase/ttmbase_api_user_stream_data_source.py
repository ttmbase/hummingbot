...
from .ttmbase_auth import TtmBASEAuth
from .ttmbase_constants import Constants
from .ttmbase_utils import TtmBASEAPIError
...
class TtmBASEAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self, ttmbase_auth: TtmBASEAuth, trading_pairs: Optional[List[str]] = []):
        self._ttmbase_auth: TtmBASEAuth = ttmbase_auth
        self._ws: TtmBASEWebsocket = None
    ...
    async def _listen_to_orders_trades_balances(self) -> AsyncIterable[Any]:
        ...
        try:
            self._ws = TtmBASEWebsocket(self._ttmbase_auth)
