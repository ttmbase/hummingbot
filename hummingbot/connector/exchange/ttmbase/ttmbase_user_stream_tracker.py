...
class TtmBASEUserStreamTracker(UserStreamTracker):
    ...
    def __init__(self,
                 ttmbase_auth: Optional[TtmBASEAuth] = None,
                 trading_pairs: Optional[List[str]] = None):
        self._ttmbase_auth: TtmBASEAuth = ttmbase_auth
        self._trading_pairs: List[str] = trading_pairs or []
        super().__init__(data_source=TtmBASEAPIUserStreamDataSource(
            ttmbase_auth=self._ttmbase_auth,
    ...
    def data_source(self) -> UserStreamTrackerDataSource:
        ...
        *required
        ...
        if not self._data_source:
            self._data_source = TtmBASEAPIUserStreamDataSource(
                ttmbase_auth=self._ttmbase_auth,
                trading_pairs=self._trading_pairs
            )
